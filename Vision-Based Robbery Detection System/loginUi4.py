...
"padding-bottom:7px;")
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_3.setText(_translate("Form", "B"))
        self.pushButton_4.setText(_translate("Form", "R"))
        self.pushButton_5.setText(_translate("Form", "D"))
        self.pushButton_6.setText(_translate("Form", "S"))
    ...
    def check_credentials(self):
        ...
        if username == 'Iffat Zahra' and password == 'iffat123':
            subprocess.Popen(['python', 'FYP_Final.py'])
        else:
            QMessageBox.warning(self.widget, 'Login Failed', 'Invalid username or password')

        # if username == 'Iffat Zahra' and password == 'iffat123':
            # QMessageBox.information(self, 'Login Successful',
            #                         'Welcome to, {}'.format("Vision-Based Robbery Detection System"))
